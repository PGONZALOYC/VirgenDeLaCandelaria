...
int cant_residuo = listaEstudiantes.size() % 7;
int cant_paginas = (listaEstudiantes.size() - cant_residuo) / 7;
if (cant_residuo != 0){
    cant_paginas += 1;
}


List<List<Estudiante>> listaPaginas = new ArrayList<>();
List<Integer> entradas_pag = new ArrayList<>();
int ultimo_index = 0;

if (listaEstudiantes.size()<7){
entradas_pag.add(listaEstudiantes.size());
} else{
...
for (int i=1; i <= cant_paginas; i++){
    List<Estudiante> lista7Estudiantes = new ArrayList<>();
    for (int j=ultimo_index; j < (ultimo_index+entradas_pag.get(i-1)); j++){
        lista7Estudiantes.add(listaEstudiantes.get(j));
    }
    ultimo_index += 7;
    listaPaginas.add(i-1, lista7Estudiantes);
}
        ...
        <div class="container" style="position: absolute;top: 40px;
            ...
            <div class="row my-3 ">
                <div class="col">
                    ...
                    <a href="ApoderadoController?accion=listar&page=1">
                        <button type="button"id="btn-listaApo" class="btn btn-light">Lista de apoderados</button>
                    </a>         
                </div>
            </div>
            <!--Buscar y agregar estudiante-->
            <div class="row my-3">
                <div class="col">
                    <h6 class="label-dni">N° de DNI del estudiante</h6>
                    <form class="d-flex" role="search" action="EstudianteController" method="post">
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination d-flex justify-content-end align-items-center">
                            <li id="contenedor-pag" class="<%
                                ...
                                %>">
                                <a  class="page-link" href="EstudianteController?accion=listar&page=<%=pagina-1%>" aria-label="Previous">
                            ...
                            %><li <%
                                ...
                                box-shadow: 5px 5px 0px 0px rgba(0,0,0,0.75);"<%
                                                                           ...
                                                                           %>EstudianteController?accion=listar&page=<%=i+1%><%
}
                                                                           %>"><span><%=i+1%></span></a></li><%
                            }
                                        %>
                            <li id="contenedor-pag" class="<%
                                ...
                                %>">
                                <a class="page-link" href="EstudianteController?accion=listar&page=<%=pagina+1%>" aria-label="Next">
            ...
            <!--Agregar estudiante-->
            <div class="modal modal-xl fade" data-bs-backdrop="static" data-bs-keyboard="false" id="modal-agregar">
                            ...
                            <form action="EstudianteController" method="post">
                                ...
                                <div class=" row">
                                    <div class="col">
                                        ...
                                        <input type="text" required minlength="8" maxlength="8" oninput="validateInput(event)" class="form-control my-1" style="background-color: #222222; border: 2px solid white; border-radius: 3px; color: white;" id="a_dniInput" name="a_DNI">


                                    </div>
                                    <div class="col">
                                        <label id="etiqueta" for="ape-paterno">Apellido Paterno:</label>
                                        <input type="text" required oninput="validateInput2(event)" class="form-control my-1"style="background-color: #222222; border: 2px solid white;border-radius: 3px;color: white; "id="a_apPaternoInput"name="a_ape-paterno">

                                    </div>  
                                    <div class="col">
                                        <label id="etiqueta" for="ape-materno">Apellido Materno:</label>
                                        <input type="text" required oninput="validateInput2(event)" class="form-control my-1"style="background-color: #222222; border: 2px solid white;border-radius: 3px;color: white; "id="a_apMaternoInput"name="a_ape-materno">

                                    </div>      
                                    <div class="col">
                                        <label id="etiqueta" for="nombres">Nombres:</label>
                                        <input type="text" required oninput="validateInput2(event)" class="form-control my-1"style="background-color: #222222; border: 2px solid white;border-radius: 3px;color: white; "id="a_nombresInput"name="a_nombres">
                                ...
                                <div class="row ">
                                    <div class="col-6">
                                        ...
                                        <input type="text" required class="form-control my-1"style="background-color: #222222; border: 2px solid white;border-radius: 3px;color: white; "id="a_direccionInput"name="a_direccion">
                                    </div>
                                    <div class="col-3">
                                ...
                                <div class="row ">
                                    <div class="col-3">
                                        ...
                                        <select class="form-select my-1" required style="border: 2px solid black;border-radius: 3px;" aria-label="Default select example" id="a_generoInput"name="a_genero">
                                            <option value="" selected disabled hidden >Seleccionar</option>
                                            <option value="1">Masculino</option>
                                            <option value="2">Femenino</option>
                                        </select>
                                        <!-- 
                                        <label id="etiqueta" for="nivel">Nivel:</label>
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input type="date" required class="form-control my-1" style="border: 2px solid black;border-radius: 3px;" id="a_fecNacInput" name="a_birthdate">
                                        <!-- 
                                        <label id="etiqueta" for="grado">Grado:</label>
            ...
            <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="modal-eliminar">
                <div class="modal-dialog">
                    <div class="modal-content" id="modal-contenido">
                        ...
                        <div class="modal-body">
                            <h6 style="color: white;">¿Está seguro de eliminar a este estudiante?</h4>
                        </div>
            ...
            <!--Editar estudiante-->
            <div class="modal modal-xl fade" data-bs-backdrop="static" data-bs-keyboard="false" id="modal-editar">
                <div class="modal-dialog ">
                    <div class="modal-content" id="modal-contenido">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form action="EstudianteController" method="post">
                                ...
                                <input type="hidden" id="e_idEditar" name="e_idEditar">
                                <div class=" row">
                                    <div class="col">
                                        <label id="etiqueta" for="DNI">N° de DNI:</label>
                                        <input type="text" class="form-control my-1" style="background-color: #222222; border: 2px solid white; border-radius: 3px; color: white;" id="e_dniInput" name="e_DNI" >


                                    </div>
                                    <div class="col">
                                        <label id="etiqueta" for="ape-paterno">Apellido Paterno:</label>
                                        <input type="text" class="form-control my-1" style="background-color: #222222; border: 2px solid white;border-radius: 3px;color: white;" id="e_apPaternoInput" name="e_ape-paterno" >

                                    </div>  
                                    <div class="col">
                                        <label id="etiqueta" for="ape-materno">Apellido Materno:</label>
                                        <input type="text" class="form-control my-1"style="background-color: #222222; border: 2px solid white;border-radius: 3px;color: white; "id="e_apMaternoInput"name="e_ape-materno">

                                    </div>      
                                    <div class="col">
                                        <label id="etiqueta" for="nombres">Nombres:</label>
                                        <input type="text" class="form-control my-1"style="background-color: #222222; border: 2px solid white;border-radius: 3px;color: white; "id="e_nombresInput"name="e_nombres">
                                ...
                                <div class="row ">
                                    <div class="col-6">
                                        <label id="etiqueta" for="direccion">Dirección:</label>
                                        <input type="text"  class="form-control my-1"style="background-color: #222222; border: 2px solid white;border-radius: 3px;color: white; "id="e_direccionInput"name="e_direccion">
                                    </div>
                                    <div class="col-3">
                                        <label id="etiqueta" for="departamento">Departamento:</label>
                                        <input type="text" class="form-control my-1"style="background-color: #222222; border: 2px solid white;border-radius: 3px;color: white; "id="e_departamentoInput"name="e_departamento">
                                    </div>
                                    <div class="col-3">
                                        <label id="etiqueta" for="distrito">Distrito:</label>
                                        <input type="text" class="form-control my-1"style="background-color: #222222; border: 2px solid white;border-radius: 3px;color: white; "id="e_distritoInput"name="e_distrito">
                                    </div>
                                </div>
                                <div class="row ">
                                    <div class="col-3">
                                        <label id="etiqueta" for="genero">Género:</label>
                                        <select class="form-select my-1" style="border: 2px solid black;border-radius: 3px;" aria-label="Default select example" id="e_generoInput"name="e_genero">
                                            <option selected >Select</option>
                                            <option value="1">Masculino</option>
                                            <option value="2">Femenino</option>
                                        </select>
                                        <!-- 
                                        <label id="etiqueta" for="nivel">Nivel:</label>
                                        <select class="form-select my-1" style="border: 2px solid black;border-radius: 3px;" aria-label="Default select example" id="nivelInput">
                                            <option selected>Select</option>
                                            <option value="1">Inicial</option>
                                            <option value="2">Primaria</option>
                                            <option value="3">Secundaria</option>
                                    ...
                                    <div class="col-9">
                                        <label id="etiqueta" for="fec-nac">Fecha de nacimiento:</label>
                                        <input type="date" class="form-control my-1" style="border: 2px solid black;border-radius: 3px;" id="e_fecNacInput" name="e_birthdate">
                                        <!--
                                     <label id="etiqueta" for="grado">Grado:</label>
                                     <select class="form-select my-1" id="grado" style="border: 2px solid black;border-radius: 3px;"aria-label="Default select example" id="gradoInput">
                                         <option selected>Select</option>
                                         <option value="1">1°</option>
                                         <option value="2">2°</option>
                                         <option value="3">3°</option>
            ...
            <!--Modal Estudiante ya registrado-->
            <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="modal-est-regist">
                <div class="modal-dialog">
                    <div class="modal-content" id="modal-contenido-error-est">
                        <div class="modal-header" style="border-bottom: none;">
                            <h4 class="modal-title" style="color: black;">Estudiante ya registrado</h4>
                        </div>
                        <div class="modal-body">
                            <h6 style="color: black; font-size: 14px;">El estudiante ya se encuentra registrado en
                                el sistema.
                            </h6>
                        </div>
                        <div class="modal-footer" style="border-top: none;" id="contenedor-botones-error-est">
